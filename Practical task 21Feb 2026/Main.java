public class Main {
    public static void main(String[] args) {
        Student[] students = new Student[] {
                new Student("KRG56789", "Tavjeet", 0, 0),
                new Student("STD98765", "Singh", 0, 0),
                new Student("KRG23456", "Sethi", 50, 0)
        };
        ...
        CheckoutRequest[] requests = new CheckoutRequest[] {
                new CheckoutRequest("KRG56789", "LAB-101", 5), 
                new CheckoutRequest("KRG56789", "LAB-102", 2),   
                new CheckoutRequest("STD98765", "LAB-103", 1)   
        };
